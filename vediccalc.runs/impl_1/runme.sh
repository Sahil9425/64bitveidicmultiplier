...
HD_PWD='D:/vediccalc/vediccalc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic64.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedic64.tcl -notrace
